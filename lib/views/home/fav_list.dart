...
class FavoriteCityList extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        Common.log4method("FavoriteCityList.build");

        return Consumer<FavoriteCityModel>(
            builder: (context, favoriteCityState, child) {
                Common.log4method("FavoriteCityList.build > Consumer<FavoriteCityModel>");
                final favItems = favoriteCityState.favItems;
